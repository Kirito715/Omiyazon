...
/**
 * Servlet implementation class ManagerItemUpdate
 */
...
public class ManagerItemUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String state = request.getParameter("itemState");
		...
		String[] str = {id,sname,genre,prefId,regionId,name,price,summary,pic1,pic2,pic3,pic4,pic5,num,state};

		if(db.updateItem(str)) {
